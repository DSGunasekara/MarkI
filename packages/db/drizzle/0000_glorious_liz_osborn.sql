...
CREATE TABLE "assignments" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "assignments_join_code_unique" UNIQUE("join_code")
);
--> statement-breakpoint
...
ALTER TABLE "assignments" ADD CONSTRAINT "assignments_employer_id_users_id_fk" FOREIGN KEY ("employer_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
